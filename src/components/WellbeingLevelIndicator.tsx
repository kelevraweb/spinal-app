...
const WellbeingLevelIndicator: React.FC<WellbeingLevelIndicatorProps> = ({ level, onContinue, gender }) => {
  ...
  const getInfoText = () => {
    switch (level) {
      case 'Low': return 'LOW level of negative effects on your well-being. You have good posture habits but there\'s always room for improvement.';
      case 'Medium': return 'MEDIUM level of negative effects on your well-being. Some adjustments to your posture habits could help you feel better.';
      case 'High': return 'HIGH level of negative effects on your well-being. Your current posture habits may be significantly impacting your daily comfort and health.';
    }
  };
